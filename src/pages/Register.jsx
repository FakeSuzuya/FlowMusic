...
import { Mail, Lock, User, Eye, EyeOff, Music2, Check } from 'lucide-react'
import './Auth.css'
      ...
      <div className="auth-container">
        <div className="auth-card glass animate-fadeIn">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Rejoignez la communauté FlowMusic</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="auth-options">
              <label className="checkbox-label">
                ...
                <span>J'accepte les <Link to="/terms" className="auth-link">conditions d'utilisation</Link></span>
              </label>
            </div>
      ...
      <div className="auth-visual">
        <div className="visual-content">
          ...
          <div className="visual-text">
            <h2>Partagez votre musique</h2>
            <p>Uploadez vos créations, créez des playlists et connectez-vous avec d'autres artistes.</p>
          </div>
        </div>
      </div>
    </div>
